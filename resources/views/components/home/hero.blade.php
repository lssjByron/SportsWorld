            ...
            <div class="w-full lg:w-5/12 px-4">
                <div class="hero-content">
                    ...
                    <ul class="flex flex-wrap items-center">
                        <li>
                            <x-button-link href="#portfolio" variant="primary" class="rounded-lg text-orange">
                                My Projects
                            </x-button-link>
                        </li>
                    </ul>
                    <div class="clients pt-16">
                        ...
                        <x-social.social-icons></x-social.social-icons>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full px-4 lg:w-6/12">
                <div class="lg:ml-auto lg:text-right">
                    <div class="relative z-10 inline-block pt-11 lg:pt-0">
                        <img
                        src="https://media.licdn.com/dms/image/C5603AQFWSvZKRDxSZg/profile-displayphoto-shrink_800_800/0/1528750259034?e=1677110400&v=beta&t=wdSqI06NjvnjHu0ieAjmIK4FrFD4t0OGFoOLYFipKHY"
                        alt="hero"
