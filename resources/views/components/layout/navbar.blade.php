      ...
      <div class="pr-4 w-60 max-w-full">
        <a href="/" class="w-full flex items-center py-2">
          <img
            ...
            alt="logo"
            class="w-[48px] lg:2-[64px] inline-block dark:hidden"
          />
          <img
      ...
      <div class="flex px-4 justify-end items-center w-full">
        <div>
          ...
          <nav
            ...
            id="navbarCollapse"
            class="absolute right-0 top-full bg-white py-5 px-6 z-50 shadow rounded-lg w-full dark:bg-slate-900 dark:text-gray-300 lg:px-0 lg:max-w-full lg:right-4 lg:block lg:static lg:shadow-none"
          >
